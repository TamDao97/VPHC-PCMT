...
@Component({
  selector: 'app-ke-hoach-cap-phong-phan-giao',
  templateUrl: './ke-hoach-cap-phong-phan-giao.component.html',
  styleUrl: './ke-hoach-cap-phong-phan-giao.component.scss'
})

export class KeHoachCapPhongPhanGiaoComponent implements OnInit {

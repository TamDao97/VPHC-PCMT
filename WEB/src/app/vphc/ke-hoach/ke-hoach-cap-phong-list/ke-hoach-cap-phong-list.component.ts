...
@Component({
  selector: 'app-ke-hoach-cap-phong-list',
  templateUrl: './ke-hoach-cap-phong-list.component.html',
  styleUrl: './ke-hoach-cap-phong-list.component.scss',
  providers: [ContextMenuService, PageService],
  encapsulation: ViewEncapsulation.None,

})
export class KeHoachCapPhongListComponent implements OnInit {

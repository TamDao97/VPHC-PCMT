...
import { KeHoachService } from 'src/app/vphc/service/ke-hoach.service';
@Component({
  selector: 'app-ke-hoach-cap-phong-edit',
  templateUrl: './ke-hoach-cap-phong-edit.component.html',
  styleUrl: './ke-hoach-cap-phong-edit.component.scss'
})
export class KeHoachCapPhongEditComponent implements OnInit, AfterViewInit, OnDestroy {

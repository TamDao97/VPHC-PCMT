...
@Component({
  selector: 'app-nguoi-phien-dich-modify',
  templateUrl: './nguoi-phien-dich-modify.component.html',
  styleUrls: ['./nguoi-phien-dich-modify.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class NguoiPhienDichModifyComponent implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    if (!this.id) {
      this.model.idPhienDichVienVPHC = uuidv4();
    }else{
      this.isEdit = true;
    }

...
@Component({
  selector: 'app-nguoi-chung-kien-modify',
  templateUrl: './nguoi-chung-kien-modify.component.html',
  styleUrls: ['./nguoi-chung-kien-modify.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class NguoiChungKienModifyComponent implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    if (!this.id) {
      this.model.idNguoiChungKien = uuidv4();
    }else{
      this.isEdit = true;
    }

...
import { ThongKeDonViComponent } from './don-vi/don-vi.component';
import { ThongKeVuViecComponent } from './vu-viec/vu-viec.component';
import { ThongKeXuLyComponent } from './xu-ly/xu-ly.component';
import { ThongKeTangVatComponent } from './tang-vat/tang-vat.component';

@NgModule({
  declarations: [
    ThongKeDonViComponent,
    ThongKeVuViecComponent,
    ThongKeXuLyComponent,
    ThongKeTangVatComponent
  ],
  imports: [
    CommonModule,
    RouterModule.forChild([
      {
        path: 'don-vi',
        component: ThongKeDonViComponent,
        data: { animation: 'ThongKeDonVi' },
      },
      {
        path: 'vu-viec',
        component: ThongKeVuViecComponent,
        data: { animation: 'ThongKeVuViec' },
      },
      {
        path: 'xu-ly',
        component: ThongKeXuLyComponent,
        data: { animation: 'ThongKeXuLy' },
      },
      {
        path: 'tang-vat',
        component: ThongKeTangVatComponent,
        data: { animation: 'ThongKeTangVat' },
      }
    ]),
    TranslationModule,
    TranslateModule,

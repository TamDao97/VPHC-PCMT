...
{
    public interface IVuViecXuLyService
    {
        /// <summary>
        /// Cập nhật vụ việc
        /// </summary>
        ...
        /// <returns></returns>
        Task UpdateAsync(string id, VuViecXuLyModifyModel model, CurrentUserModel currentUser);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Task<VuViecXuLyModifyModel> GetByIdAsnyc(string id);
    }
}
